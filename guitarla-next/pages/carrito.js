            ...
            {carrito.length === 0 ? 'Carrito Vacio' : (
              carrito.map(producto => (
                <div key={producto.id} className={styles.producto}>
                  <div>
                    <Image width={250} height={480} src={producto.imagen} alt={producto.nombre}></Image>
                  </div>
                  <div>
                  ...
                  <button onClick={e => eliminarProducto(producto.id)} className={styles.eliminar} type='button'>
                    X
                  </button>
                </div>
              ))
